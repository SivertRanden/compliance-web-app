...
exports.getLawsByThemeId = function(id) {
  var promise = new Promise(function(resolve, reject) {
    db.serialize(() => {
      db.all(
        `SELECT l.* FROM law as l, theme as t, laws_sub_sections as ls, themes_sub_sections as ts
      WHERE t.id_theme = ` +
          escape(id) +
...
exports.getRegulationsByThemeId = function(id) {
  var promise = new Promise(function(resolve, reject) {
    db.serialize(() => {
      db.all(
        `SELECT r.* FROM regulation as r, theme as t, regulations_sub_sections as rs, themes_sub_sections as ts
      WHERE t.id_theme = ` +
          escape(id) +
...
exports.getAnswersByThemeId = function(id) {
  var promise = new Promise(function(resolve, reject) {
    db.serialize(() => {
      db.all(
        `SELECT a.* FROM answer as a, theme as t, themes_answers as ta
      WHERE t.id_theme = ` +
          escape(id) +
